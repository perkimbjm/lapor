      ...
      <div className="max-w-5xl mx-auto space-y-8 pb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
              <div>
                ...
                <input type="text" value={config.navbarBrand} onChange={e => setConfig({...config, navbarBrand: e.target.value})} className="w-full p-3 rounded-xl border dark:bg-slate-900 dark:border-slate-700" />
              </div>
              <div>
                <label className="block text-xs font-black uppercase text-slate-500 mb-2">Login Button Text</label>
                <input type="text" value={config.loginButtonText} onChange={e => setConfig({...config, loginButtonText: e.target.value})} className="w-full p-3 rounded-xl border dark:bg-slate-900 dark:border-slate-700" />
              </div>
            </div>
            <div className="space-y-4">
              <div>
                <label className="block text-xs font-black uppercase text-slate-500 mb-2">Menu: Beranda</label>
                <input type="text" value={config.menuBeranda} onChange={e => setConfig({...config, menuBeranda: e.target.value})} className="w-full p-3 rounded-xl border dark:bg-slate-900 dark:border-slate-700" />
              </div>
              <div>
                <label className="block text-xs font-black uppercase text-slate-500 mb-2">Menu: Lapor</label>
                <input type="text" value={config.menuLapor} onChange={e => setConfig({...config, menuLapor: e.target.value})} className="w-full p-3 rounded-xl border dark:bg-slate-900 dark:border-slate-700" />
              </div>
              <div>
                <label className="block text-xs font-black uppercase text-slate-500 mb-2">Menu: Cek Status</label>
                <input type="text" value={config.menuCekStatus} onChange={e => setConfig({...config, menuCekStatus: e.target.value})} className="w-full p-3 rounded-xl border dark:bg-slate-900 dark:border-slate-700" />
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input type="text" value={config.heroTitle} onChange={e => setConfig({...config, heroTitle: e.target.value})} className="w-full p-3 rounded-xl border dark:bg-slate-900 dark:border-slate-700" />
              </div>
              <div>
                <label className="block text-xs font-black uppercase text-slate-500 mb-2">Accent Title</label>
                <input type="text" value={config.heroSubtitle} onChange={e => setConfig({...config, heroSubtitle: e.target.value})} className="w-full p-3 rounded-xl border dark:bg-slate-900 dark:border-slate-700" />
              </div>
            </div>
            <div>
              <label className="block text-xs font-black uppercase text-slate-500 mb-2">Description</label>
              <textarea value={config.heroDescription} onChange={e => setConfig({...config, heroDescription: e.target.value})} className="w-full p-3 rounded-xl border dark:bg-slate-900 dark:border-slate-700 h-24" />
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label className="block text-xs font-black uppercase text-slate-500 mb-2">Button: Lapor</label>
                <input type="text" value={config.heroLaporText} onChange={e => setConfig({...config, heroLaporText: e.target.value})} className="w-full p-3 rounded-xl border dark:bg-slate-900 dark:border-slate-700" />
              </div>
              <div>
                <label className="block text-xs font-black uppercase text-slate-500 mb-2">Button: Pantau</label>
                <input type="text" value={config.heroPantauText} onChange={e => setConfig({...config, heroPantauText: e.target.value})} className="w-full p-3 rounded-xl border dark:bg-slate-900 dark:border-slate-700" />
              </div>
            </div>
            <div>
              ...
              <div className="flex items-center gap-4">
                ...
                <label htmlFor="bg-upload" className="cursor-pointer flex items-center gap-2 px-4 py-2 bg-slate-100 dark:bg-slate-700 rounded-xl font-bold text-sm">
                  <ImageIcon size={18} /> Upload Background
                </label>
        ...
        <div className="bg-white dark:bg-slate-800 p-8 rounded-3xl shadow-sm border border-slate-100 dark:border-slate-700">
          ...
          <div>
            ...
            <textarea value={config.footerText} onChange={e => setConfig({...config, footerText: e.target.value})} className="w-full p-3 rounded-xl border dark:bg-slate-900 dark:border-slate-700 h-24" />
          </div>
        </div>
